...
var submenu = document.querySelector(".header__function__categories__menu");
var listToShow = document.querySelector('.header__function__categories');
listToShow.addEventListener("mouseover", function () {
  submenu.classList.add('show');
});
listToShow.addEventListener("mouseout", function () {
